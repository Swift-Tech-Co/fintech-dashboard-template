...
Production-ready FinTech dashboard template. Includes account overview, transaction history, analytics charts, KYC status indicators, and role-based access control UI. Built for neobanks, payment platforms, and financial data products.
